...
namespace gorynych {
    namespace worker_manager {
        ...
        WorkerManager::runRemoveIscsiTargetWorker(const uint id, const RemoveIscsiTargetCommand &command) {
            ...
            removeIscsiTargetWorkerFactory_.init(removeIscsiTargetWorkerCommand);
            RemoveIscsiTargetWorker *removeIscsiTargetWorker = dynamic_cast<RemoveIscsiTargetWorker *>(removeIscsiTargetWorkerFactory_.createWorker(
                    id));
            RemoveIscsiTargetWorkerResponse &response = (RemoveIscsiTargetWorkerResponse &) removeIscsiTargetWorker->doWork();
            return response;
